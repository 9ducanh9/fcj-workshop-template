...
Là sinh viên năm cuối ngành Hệ thống Thông tin và đang tham gia AWS Bootcamp, sự kiện giúp tôi nhìn rõ khoảng cách giữa việc biết công nghệ và khả năng dùng công nghệ để giải quyết vấn đề doanh nghiệp.

Bốn phần chia sẻ đề cập đến thị trường cloud và career visibility; Data Architecture thực tế; giao tiếp và chiến lược “Blue Ocean”; tư duy AI cho fresher. Giá trị lớn nhất với tôi là cách chuyển các bài học thành hành động cho nghề nghiệp và LiveCap.
...
Tôi nhận ra giao tiếp không phải “kỹ năng mềm” tách rời chuyên môn. Nó tác động trực tiếp đến làm rõ yêu cầu, phối hợp nhóm, phỏng vấn và cơ hội nghề nghiệp. Nếu hướng đến BSA hoặc Solution Architect, tôi phải biết đặt câu hỏi, nhận ra ý định ẩn, giải thích trade-off và xây dựng niềm tin với stakeholder. Tôi cũng không nên chờ đến khi “hoàn toàn sẵn sàng” mới xuất hiện; visibility phải được xây dựng đều qua cộng đồng, sự kiện, LinkedIn, GitHub và chia sẻ dự án.
...
Tôi có thể dùng AI để tăng tốc coding, tài liệu hóa, debugging và so sánh kiến trúc, nhưng không giao việc hiểu AWS hoặc yêu cầu cho AI. Với LiveCap, AI nên là reviewer và accelerator. Tôi phải tự giải thích CloudFront, S3, CloudWatch, Transcribe, Translate và vì sao kiến trúc mục tiêu có thể cân nhắc ALB, ECS/Fargate, WAF; đồng thời trình bày trade-off về chi phí, độ trễ, bảo mật và vận hành.

## Bài học tổng hợp sau sự kiện

Bốn chủ đề tạo thành một mạch thống nhất. Từ anh Nguyễn Gia Hưng, tôi học rằng phát triển nghề nghiệp cần Capability, Visibility và Consistency. Từ anh Bình Cẩm Vĩnh, tôi hiểu hệ thống thực tế đòi hỏi tư duy kiến trúc cùng khả năng hiểu business. Từ chị Như Trần, tôi nhận ra giao tiếp, sự hiện diện và quan hệ tin cậy có thể tạo ra cơ hội ngoài quy trình ứng tuyển công khai. Từ anh Khang Nguyễn, tôi xác định AI nên khuếch đại năng lực chứ không thay thế sự hiểu biết.

Kỹ thuật cần thiết nhưng chưa đủ. Để theo đuổi Cloud/Data Platform Engineering, Business System Analyst và Solution Architect, tôi phải hiểu kinh doanh, giao tiếp rõ, xây dựng visibility và học nhất quán. Ba hướng này gặp nhau ở khả năng hiểu nhu cầu, thiết kế hệ thống và giải thích giải pháp bằng ngôn ngữ kỹ thuật lẫn kinh doanh.

## Đóng góp cá nhân và kế hoạch áp dụng vào LiveCap

Sau sự kiện, tôi xác định năm nhóm hành động cụ thể:

1. **Đưa LiveCap từ “working demo” thành dự án có tư duy production.** Tôi sẽ làm rõ kiến trúc, runtime flow, vai trò dịch vụ AWS và phân biệt phần đã triển khai với kiến trúc mục tiêu. Tài liệu cần nêu chi phí, bảo mật, logging, monitoring và hướng mở rộng.

2. **Tăng visibility của dự án.** Tôi sẽ giữ repository rõ ràng, cải thiện README, setup guide và viết bài kỹ thuật. Mỗi thay đổi cần trả lời: tôi học gì, đổi gì và vì sao. GitHub, LinkedIn sẽ là bằng chứng của quá trình học, không chỉ là nơi đăng kết quả.

3. **Hiểu người dùng và nghiệp vụ.** Tôi cần xác định ai dùng LiveCap, họ gặp khó khăn ở đâu và đầu ra nào hữu ích. Transcript export phải dễ đọc, có cấu trúc, hỗ trợ xem lại workshop, cuộc họp và trao đổi song ngữ thay vì chỉ là dữ liệu tải xuống.

4. **Sử dụng AI có trách nhiệm.** Tôi sẽ dùng AI để review code, tài liệu, kiến trúc và phát hiện vấn đề production. Mọi đề xuất quan trọng phải được kiểm tra và tôi phải tự giải thích quyết định cuối cùng. Khả năng kiểm chứng vẫn là trách nhiệm của người xây dựng.

5. **Chuẩn bị có định hướng.** Tôi sẽ đào sâu AWS, data flow, system design, deployment và luyện cách giải thích hệ thống bằng ngôn ngữ kỹ thuật lẫn nghiệp vụ. Tôi cũng cần tham gia sự kiện, xây dựng quan hệ và cập nhật GitHub, blog, LinkedIn đều đặn thay vì chỉ làm gần deadline.

## Kết luận

Sẵn sàng cho nghề nghiệp không chỉ là biết công cụ. Tôi cần hiểu hệ thống, kinh doanh, giao tiếp, AI và cách làm năng lực được nhìn thấy. Bước tiếp theo là cải thiện LiveCap như một sản phẩm kỹ thuật và portfolio artifact thể hiện quá trình học, tư duy production cùng định hướng nghề nghiệp.
